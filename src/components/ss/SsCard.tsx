...
export interface SsCardProps extends Omit<HTMLMotionProps<"div">, "ref"> {
  variant?: "default" | "glass" | "accent" | "elevated";
  hover?: boolean;
  children: ReactNode;
}

const variantClasses: Record<NonNullable<SsCardProps["variant"]>, string> = {
...
export const SsCard = forwardRef<HTMLDivElement, SsCardProps>(function SsCard(
