...
export interface SsInputProps extends InputHTMLAttributes<HTMLInputElement> {
  leftIcon?: ReactNode;
  rightIcon?: ReactNode;
}

export const SsInput = forwardRef<HTMLInputElement, SsInputProps>(function SsInput(
